...
#func get_data(idx: int, args: Dictionary) -> Dictionary:
	#_noise.seed = _generator.seed
#
	#_noise.frequency = args["frequency"]
	#_noise.fractal_octaves = args["octaves"]
	#_noise.fractal_lacunarity = args["lacunarity"]
